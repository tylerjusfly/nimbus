...
*   **Real-Time Email Sync:** Fetches emails from your IMAP server and keeps them updated in real-time.
...
2.  **IMAP Connection:** Once signed in, the app will simulate connecting to an IMAP account and fetching emails into Firestore.
